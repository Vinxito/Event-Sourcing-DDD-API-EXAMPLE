...
import com.dummy.printer.application.change_status.event.DeviceStatusChangedDomainEvent;
import com.dummy.printer.application.create.event.DeviceCreatedDomainEvent;
import com.dummy.printer.application.remove.event.DeviceRemovedDomainEvent;
...
import com.dummy.shared.domain.AggregateRoot;
